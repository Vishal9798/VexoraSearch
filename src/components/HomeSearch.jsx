"use client"//to fix use state error
...
export default function HomeSearch() {
  ...
  return (
    ...
    justify-center sm:flex-row mt-8 sm:space-x-4'>
        <button onClick={handleSubmit}
          className='bg-[#f8f9fa] rounded-md text-sm
         text-gray-800 hover:ring-gray-200 focus:outline-none
          active:ring-gray-300 hover:shadow-md w-36 h-10 
          transition-shadow'>Search
        </button>
        ...
        disabled={randomSearchLoading}
         ...
         text-gray-800 hover:ring-gray-200 focus:outline-none
          ...
          {randomSearchLoading ? 'Searching...' : 'Explore Random Search'}
        </button>
